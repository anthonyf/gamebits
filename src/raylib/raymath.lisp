(uiop:define-package #:gamebits/raymath
  (:use #:cl)
  (:mix #:gamebits/raylib)
  (:export ))

(in-package #:gamebits/raymath)
;; /**********************************************************************************************
;; *
...
;;     return result;
;; }
(cffi:defcfun ("Vector2Zero" vector2-zero) (:struct %vector2))
...
;;     return result;
;; }
(cffi:defcfun ("Vector2One" vector2-one) (:struct %vector2))
...
;;     return result;
;; }
(cffi:defcfun ("Vector2AddValue" vector2-add-value) (:struct %vector2)
  (v (:struct %vector2))
  (add :float))
...
;;     return result;
;; }
(cffi:defcfun ("Vector2Subtract" vector2-subtract) (:struct %vector2)
  (v1 (:struct %vector2))
  (v2 (:struct %vector2)))
...
;;     return result;
;; }
(cffi:defcfun ("Vector2SubtractValue" vector2-subtract-value) (:struct %vector2)
  (v (:struct %vector2))
  (sub :float))
...
;;     return result;
;; }
(cffi:defcfun ("Vector2LengthSqr" vector2-length-sqr) :float
  (v (:struct %vector2)))
...
;;     return result;
;; }
(cffi:defcfun ("Vector2DotProduct" vector2-dot-product) :float
  (v1 (:struct %vector2))
  (v2 (:struct %vector2)))
